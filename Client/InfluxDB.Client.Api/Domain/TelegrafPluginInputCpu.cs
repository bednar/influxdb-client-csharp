...
namespace InfluxDB.Client.Api.Domain
{
    ...
    public partial class TelegrafPluginInputCpu : TelegrafRequestPlugin,  IEquatable<TelegrafPluginInputCpu>
    {
        ...
        {
            return this.Equals(input as TelegrafPluginInputCpu);
        }

        /// <summary>
        /// Returns true if TelegrafPluginInputCpu instances are equal
        /// </summary>
        /// <param name="input">Instance of TelegrafPluginInputCpu to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TelegrafPluginInputCpu input)
        {
            if (input == null)
                return false;
