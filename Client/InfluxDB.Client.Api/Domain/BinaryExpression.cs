...
namespace InfluxDB.Client.Api.Domain
{
    ...
    /// </summary>
    [DataContract]
    public partial class BinaryExpression :  IEquatable<BinaryExpression>
    {
        /// <summary>
        ...
        public BinaryExpression(string type = default(string), string _operator = default(string), Expression left = default(Expression), Expression right = default(Expression))
        {
            this.Type = type;
        ...
        [JsonConverter(typeof(BinaryExpressionLeftAdapter))]
        ...
        [JsonConverter(typeof(BinaryExpressionRightAdapter))]
